...
abstract class BaseFacebook
{
  ...
  public static $DOMAIN_MAP = array(
    ...
    'graph'       => 'https://graph.beta.facebook.com/',
  ...
  public function getLoginUrl($params=array()) {
    ...
    return $this->getUrl(
      ...
      array_merge(array(
                    'client_id' => $this->getAppId(),
                    'redirect_uri' => 'http://rinkeshchauhanfb.comoj.com/rtcamp/index.php', // possibly overwritten
                    'state' => $this->state),
                  $params));
  }
  ...
  protected function getAccessTokenFromCode($code, $redirect_uri = null) {
    ...
    if ($redirect_uri === null) {
      $redirect_uri = 'http://rinkeshchauhanfb.comoj.com/rtcamp/index.php';
    }
